...
<ul>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#official-resources">
   Official Resources
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#external-resources">
   External Resources
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#community">
   Community
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#podcasts">
   Podcasts
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#official-examples">
   Official Examples
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#tutorials">
   Tutorials
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#development-tools">
   Development Tools
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#syntax-highlighting">
   Syntax Highlighting
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#snippets">
   Snippets
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#autocomplete">
   Autocomplete
  </a>
 </li>
 <li>
  <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#libraries--plugins">
   Libraries & Plugins
  </a>
  <ul>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#routing">
     Routing
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#ajaxdata">
     Ajax/Data
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#state-management">
     State Management
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#validation">
     Validation
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#ui-components">
     UI Components
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#i18n">
     i18n
    </a>
   </li>
   ...
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#boilerplates">
     Boilerplates
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#scaffolding">
     Scaffolding
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#integrations">
     Integrations
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#general-pluginsdirectives">
 ...
 <li>
  ...
  <ul>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#open-source">
     Open Source
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#appswebsites">
     Apps/Websites
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#interactive-experiences">
     Interactive Experiences
    </a>
   </li>
   <li>
    <a href="https://github.com/vuejs/awesome-vue/blob/master/README.md#enterprise-usage">
     Enterprise Usage
    </a>
   </li>
  </ul>
